...
@RestController
@RequestMapping("/archivo_relacionado")
@Api(tags = {"Archivo_Relacionado"})
public class ArchivoRelacionadoController {
    ...
    public ResponseEntity<?> findByTramiteRegistrado(@PathVariable(value = "id")Long  id) {
        try{
            Optional<List<ArchivoRelacionado>> result = archivoRelacionadoService.findByTramitesRegistrados(id);
            if(result.isPresent()){
    ...
    public ResponseEntity<?> create(@RequestBody ArchivoRelacionado archivoRelacionado) {
        try {
            ArchivoRelacionado arcRelacionadoCreated = archivoRelacionadoService.create(archivoRelacionado);
    ...
    @PutMapping("/{id}")
    @ResponseBody
    public ResponseEntity<?> update(@PathVariable(value = "id") Long id, @RequestBody ArchivoRelacionado archivoRelacionadoModificado) {
        try {
            Optional<ArchivoRelacionado> arcRelacionadoUpdated = archivoRelacionadoService.update(archivoRelacionadoModificado, id);
